...
try:
    ...
    for reel,index in [("LEFT",14),("CENTER",3),("RIGHT",3)]:fixture("REEL_STOP",{"spinId":spin,"reel":reel,"pressedIndex":8,"stopIndex":index,"slip":6 if reel=="LEFT" else 0,"durationMs":380})
