...
public enum InternalRole {
    ...
    public DisplayRole display(boolean premiumB){
        ...
        return switch(this){case BIG,REG,MISS->DisplayRole.MISS;case CHERRY,CHERRY_BIG,CHERRY_REG->DisplayRole.CHERRY;case PIERO,PIERO_BIG,PIERO_REG->DisplayRole.PIERO;case GRAPE->DisplayRole.GRAPE;case REPLAY->DisplayRole.REPLAY;case BELL->DisplayRole.BELL;};
    }
