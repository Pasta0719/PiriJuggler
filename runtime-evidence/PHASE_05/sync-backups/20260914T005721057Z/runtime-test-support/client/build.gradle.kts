...
val port = if ((phase == "PHASE_05" || phase.startsWith("PHASE_05_BAR_"))) "25589" else if ((phase == "PHASE_04" || phase == "PHASE_05_REEL_REGRESSION", "PHASE_05_BAR_BIG", "PHASE_05_BAR_REG")) "25588" else if (phase == "PHASE_03") "25587" else if (phase == "PHASE_02") "25586" else "25585"
