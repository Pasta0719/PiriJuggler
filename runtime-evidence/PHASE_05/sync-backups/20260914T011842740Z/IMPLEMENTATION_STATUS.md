...
| 05 | IN_PROGRESS | RNG / Normal Game / Replay / Simulator |
...
```text
Last ./gradlew test: PASS (Phase05 v4; 142 tests; exit0; runtime-evidence/PHASE_05/gradle-test.log)
Last ./gradlew build: PASS (Phase05 v4; exit0; runtime-evidence/PHASE_05/gradle-build.log; packagePiriJars exit0)
```
...
## Phase05 — BLOCKED: BONUS_TYPE_PUBLIC_STATE
