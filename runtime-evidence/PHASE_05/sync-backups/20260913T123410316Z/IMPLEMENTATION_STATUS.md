...
```text
Last ./gradlew test: PASS (Phase04 v4; 124 tests; exit0; runtime-evidence/PHASE_04/gradle-test.log)
Last ./gradlew build: PASS (Phase04 v4; exit0; runtime-evidence/PHASE_04/gradle-build.log; packagePiriJars exit0)
```
