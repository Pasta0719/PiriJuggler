...
class ReelRoundTest {
    ...
    @Test void earlyStopConsumesSequenceAndUsesServerTimeWithPing(){
        ...
        var valid=r.receive(OWNER,request(PacketType.STOP_LEFT,2),600_000_000,100);assertTrue(valid.accepted());assertEquals(11,valid.choice().pressedIndex());assertEquals(1,r.stoppedMask());
