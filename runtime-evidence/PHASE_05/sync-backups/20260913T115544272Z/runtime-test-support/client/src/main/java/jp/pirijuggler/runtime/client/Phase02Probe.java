...
public final class Phase02Probe {
    ...
    public static boolean enabled() { return System.getProperty("piri.runtime.scenario", "").startsWith("phase02") || System.getProperty("piri.runtime.scenario", "").startsWith("phase03") || System.getProperty("piri.runtime.scenario", "").startsWith("phase04"); }
    ...
    public static void tick(MinecraftClient client) {
            ...
            if (Files.exists(instruction)) {
                ...
                if (id > completed && client.player != null && client.world != null && client.interactionManager != null) {
                    ...
                    switch (kind) {
                        ...
                        case "capture" -> ScreenshotRecorder.saveScreenshot(client.runDirectory,(System.getProperty("piri.runtime.scenario", "").startsWith("phase04")?"phase04-":"phase03-")+command.get("label").getAsString()+".png",client.getFramebuffer(),message -> {});
        ...
        if(System.getProperty("piri.runtime.scenario", "").startsWith("phase03") || System.getProperty("piri.runtime.scenario", "").startsWith("phase04")) {
