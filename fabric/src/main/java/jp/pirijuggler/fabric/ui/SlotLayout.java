...
public final class SlotLayout {
    ...
    public static final Rect DATA=new Rect(330,20,1260,185), CABINET=new Rect(290,205,1340,835), LAMP=new Rect(350,390,300,170), REELS=new Rect(670,300,900,390), STATUS=new Rect(670,710,900,95);
