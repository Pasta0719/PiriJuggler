...
try:
 ...
 check('GOD presentation did not choose result',session()['internal_role']=='GOD' and session()['bonus_type']=='BIG',{'role':session()['internal_role'],'bonus':session()['bonus_type']}); manifest['passed']=True
