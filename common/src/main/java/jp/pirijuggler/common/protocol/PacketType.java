...
public enum PacketType {
    ...
    ADMIN_SET_SETTING(12), ADMIN_SET_AUTO(13), ADMIN_SET_ENABLED(14), ADMIN_RESET_DAILY(15), ADMIN_CLOSE(16),
    ...
    REMOTE_MACHINE_SNAPSHOT(119), REMOTE_MACHINE_SPIN(120), REMOTE_MACHINE_STOP(121),
    REMOTE_MACHINE_NOTICE(122), REMOTE_MACHINE_BONUS(123), REMOTE_MACHINE_REMOVE(124), REMOTE_MACHINE_SOUND(125);
