# Piri GOD — locked production payout target

The production target is now locked to:
...
These values intentionally match the Kamigami no Kiseki published benchmark.

This does **not** mean the underlying probabilities are copied unchanged.
